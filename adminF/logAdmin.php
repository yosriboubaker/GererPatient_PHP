...
if (isset($_SESSION["user_nom"] )) {
    header("Location: /projetExamenPatient/adminF/ajoutAdmin.php");
    }else{
?>
<!DOCTYPE html>
<html lang="en">
...
<body style="text-align:center;">
    ...
    <br>
    <!--<form action="logggAdmin.php" method="POST">
        <label for="fname">nom </label><br>
        <input type="text" id="nomAdmin" name="nomAdmin" value=""><br><br>
        <label for="fname">password </label><br>
        <input type="password" id="motDePasseAdmin" name="motDePasseAdmin" value=""><br><br>
        <input type="reset" value="Annuler">
        <input type="submit" value="Enregistrer">
    </form>-->

    <div id="Container">
        <form class="form" action="logggAdmin.php" method="POST">
            <input class="form-content" type="text" id="nomAdmin" name="nomAdmin" placeholder="UserName" />
            <input class="form-content" type="password" id="motDePasseAdmin" name="motDePasseAdmin"
