...
<body>
    ...
    <form action="loggg.php" method="POST">
        <label for="fname">votre numero de telephone</label><br>
        <input type="text" id="codeP" name="numTel" value=""><br>
        <input type="reset" value="Annuler">
        <input type="submit" value="Enregistrer">
    </form>
-->
    <div id="Container">
        <form class="form" action="loggg.php" method="POST">
            <div id="login-lable">Login</div>
            <input class="form-content" id="codeP" name="numTel" type="text" placeholder="numero de telephone" />
